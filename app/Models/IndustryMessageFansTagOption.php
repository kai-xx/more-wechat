...
class IndustryMessageFansTagOption extends Model
{
    use SoftDeletes;
    /**
     * 应该被调整为日期的属性
    ...
    const TABLE_NAME = 'mb_oa_wechat_industry_message_fans_tag_option';
    protected $table = self::TABLE_NAME;

    const DB_FILED_ID                   = 'id';
    const DB_FILED_INDUSTRY_MESSAGE_ID  = 'industry_message_id';
    ...
    protected $fillable = [
        self::DB_FILED_ID,
        self::DB_FILED_INDUSTRY_MESSAGE_ID,
