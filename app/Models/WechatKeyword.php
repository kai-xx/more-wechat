...
class WechatKeyword extends Model
{
    ...
    const TABLE_NAME = 'mb_oa_wechat_keyword';
    ...
    const TYPE_TEXT                    = 1; // 1关键词类型：文本
    const TYPE_IMAGE                   = 2; // 2关键词类型：图片
    const TYPE_GRAPHIC                 = 3; // 3关键词类型：图文
    const TYPE_URI                     = 4; // 4关键词类型：链接
    const TYPE_VIDEO                   = 5; // 5关键词类型：视频
    const TYPE_VOICE                   = 6; // 6关键词类型：音频
